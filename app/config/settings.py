...
TIKTOK_BUSINESS_APP_ID = os.getenv("TIKTOK_BUSINESS_APP_ID", "").strip()
TIKTOK_BUSINESS_APP_SECRET = os.getenv("TIKTOK_BUSINESS_APP_SECRET", "").strip()
TIKTOK_CONNECTION_DIR = Path(
    os.getenv("TIKTOK_CONNECTION_DIR", PROJECT_ROOT / "data" / "private_integrations")
)
...
FINANCE_UAT_MODE = env_bool("FINANCE_UAT_MODE", True)
