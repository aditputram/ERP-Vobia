...
MODULE_TABS = {
    ...
    "operation": (
        ...
        ("inbound", "Inbound", "Warehouse", ("inventory:inbound", "inventory:inbound_po_receipt_pdf", "inventory:inbound_po_checklist_pdf", "inventory:inbound_pending_report_pdf", "inventory:inbound_completed_report_pdf")),
