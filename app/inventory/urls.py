...
urlpatterns = [
    ...
    path("inbound/pending-report.pdf", views.inbound_pending_report_pdf, name="inbound_pending_report_pdf"),
    path("inbound/completed-report.pdf", views.inbound_completed_report_pdf, name="inbound_completed_report_pdf"),
