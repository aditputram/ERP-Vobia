...
class SalesReportRouteTests(TestCase):
    ...
    def test_sales_draft_matrix_months_metrics_and_scoped_save(self):
        ...
        self.assertContains(page, "<strong>Subtotal</strong>")
        self.assertContains(page, "data-draft-row-history-qty")
        self.assertContains(page, "data-draft-subtotal-history-qty")
        ...
        self.assertContains(page, f'data-status-categories="{first.status_id}:{first.category_id}"')
